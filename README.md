...
3. **习题编号**：习题 ID 固定为五位数字。第一位表示六部分中的所属部分，中间两位表示章号，最后两位表示本章内的习题序号；即 `1xxxx` 至 `6xxxx` 依次对应语法和标准库、开发与工程基础、数据结构与算法、系统编程、项目案例和嵌入式。
...
教程规划为六大模块，合称“梦猫大典”。“语法和标准库”保持现有结构，其余模块随正文建设逐步补全：
