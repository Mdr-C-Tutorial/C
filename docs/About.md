...
11. 对于目前大学本科 C 语言课程教学中的一些怪现状，如：
    ...
    3. 忽略程序设计思维的培养，忽略对编程语言理论 (Programming Language Theory, PLT) 的讲解，忽略编程语言与计算机科学 (Computer Science, CS) 的关系等，我们深恶痛绝，并殷切希望现状改善，还广大 C 语言学习者一个规范，与时俱进，可以切实提高个人编程能力和素质的 C 语言程序设计课堂。
12. 本教程的适宜受众：**愿意认真学 C 的人。**
13. **祝大家学习顺利！**

## 教程结构

教程正文由第 0 部分和六个专业模块组成，并按以下顺序组织：

0. **导读与学习指南**：说明教程边界、学习路线、工具入口、资料检索和全站使用方式。
1. **语法和标准库**：通过单文件程序学习 C 语言规则、对象模型与标准库。
2. **开发与工程基础**：学习必要的命令行操作、编译与链接、Git、多文件组织、构建系统、调试、测试、程序检查，以及范围受限的库接口实现练习。
3. **数据结构与算法**：学习数据结构、算法设计、正确性论证、复杂度分析及其 C 实现。
4. **系统编程**：学习操作系统接口、文件、进程、线程、网络和终端等能力。
5. **项目案例**：综合前述知识完成项目，并阅读具有代表性的 C 项目源码。
6. **嵌入式**：沿 MCU 裸机、驱动与通信、RTOS、嵌入式 Linux、质量与交付的路线学习嵌入式软件开发。

第一部分的既有正文已按新的认知顺序完成迁移；第二部分已接收原先散落在语言章节和项目目录中的工程内容；第三至六部分已经按各自的完整学习路径排出目录。目录描述课程边界，不表示所有规划内容都已经写完。
