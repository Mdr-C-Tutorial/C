...
1. **语法和标准库**：学习 C 语言规则、对象模型与标准库。
2. **开发与工程基础**：学习必要的命令行操作、编译与链接、Git、多文件组织、构建系统、调试、测试和程序检查工具。
3. **数据结构与算法**：学习数据结构、算法设计、正确性论证、复杂度分析及其 C 实现。
4. **系统编程**：学习操作系统接口、文件、进程、线程、网络和终端等能力。
5. **项目案例**：综合前述知识完成项目，并阅读具有代表性的 C 项目源码。
6. **嵌入式**：学习面向微控制器、外设和硬件抽象层的 C 开发。

“语法和标准库”的主目录已经确定，其余部分仍会随着正文建设逐步补全。六部分描述的是课程边界，不表示所有内容已经完成。
