...
题型改编自 [Exercism C Track 的 Circular Buffer](https://github.com/exercism/c/tree/main/exercises/practice/circular-buffer)，采用 MIT 许可。接口、约束、解析与参考实现均已重新编写，完整说明见[习题来源与许可](/教程/题解/来源与许可#11101)。
