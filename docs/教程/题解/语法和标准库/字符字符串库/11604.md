...
题型改编自 [Exercism C Track 的 Run-Length Encoding](https://github.com/exercism/c/tree/main/exercises/practice/run-length-encoding)，采用 MIT 许可。本题重新定义了错误语义、文法和精确分配要求，完整说明见[习题来源与许可](/教程/题解/来源与许可#11604)。
