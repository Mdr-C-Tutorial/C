...
题型改编自 [Exercism C Track 的 Pangram](https://github.com/exercism/c/tree/main/exercises/practice/pangram)，采用 MIT 许可。本题增加了空指针语义和执行字符集可移植性要求，完整说明见[习题来源与许可](/教程/题解/来源与许可#11603)。
