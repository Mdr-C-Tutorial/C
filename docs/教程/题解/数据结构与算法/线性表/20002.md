...
题型借鉴 Pat Morin 的 [Open Data Structures](https://opendatastructures.org/) 中数组表的增长与区间搬移思路，原作采用 [CC BY 2.5 Canada](https://creativecommons.org/licenses/by/2.5/ca/)。本题改写为 C 接口，并增加重叠规则、大小溢出和失败保证；完整记录见[习题来源与许可](/教程/题解/来源与许可#20002)。
