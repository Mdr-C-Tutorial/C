...
题型改编自 [Exercism C Track 的 Binary Search](https://github.com/exercism/c/tree/main/exercises/practice/binary-search)，采用 MIT 许可。本题把精确匹配扩展为下界语义，并增加不变式证明要求，完整说明见[习题来源与许可](/教程/题解/来源与许可#30509)。
