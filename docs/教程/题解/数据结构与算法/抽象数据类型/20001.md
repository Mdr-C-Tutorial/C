...
题型借鉴 Pat Morin 的 [Open Data Structures](https://opendatastructures.org/) 中数组栈及抽象接口的组织方式，原作采用 [CC BY 2.5 Canada](https://creativecommons.org/licenses/by/2.5/ca/)。本题改写为不透明 C 接口，并补充状态码、溢出与失败保证；完整记录见[习题来源与许可](/教程/题解/来源与许可#20001)。
