...
```
它们以“元素个数”为单位返回成功读写的元素数量。若返回值小于 `nmemb`，需要结合 `feof` / `ferror` 判断是文件结束还是错误（见 15.5）。
...
<Exercise id="11413" :d="5" :w="4" scope="*">
