...
更偏“声明规则”的角度见：[9.4.7 存储期 链接](/教程/正文/语法和标准库/9_对象模型/9_4_声明/9_4_7_存储期_链接)。
...
<Exercise id="10916" :d="1" :w="2">

写一个函数返回局部变量地址，并解释为什么这是 UB；再写一个修正版本（例如使用 `static` 或动态分配），并说明两种修正的差异。

</Exercise>

<Exercise id="10917" :d="1" :w="2">
