...
其中，`my_char_t`、`my_char_p`、`fp` 分别是 `char`、`char*`、`char (*)(void)` 的别名。更完整的用法与风格取舍见 [9.5 typedef](/教程/正文/语法和标准库/9_对象模型/9_5_typedef.md)。

## 4. 本节扩展

本节涉及的若干关键字/特性，在本章后续小节中单独展开：

1. [9.4.1 typeof](/教程/正文/语法和标准库/9_对象模型/9_4_声明/9_4_1_typeof)
2. [9.4.2 constexpr](/教程/正文/语法和标准库/9_对象模型/9_4_声明/9_4_2_constexpr)
3. [9.4.3 const volatile](/教程/正文/语法和标准库/9_对象模型/9_4_声明/9_4_3_const_volatile)
4. [9.4.4 restrict](/教程/正文/语法和标准库/9_对象模型/9_4_声明/9_4_4_restrict)
5. [9.4.5 alignas](/教程/正文/语法和标准库/9_对象模型/9_4_声明/9_4_5_alignas)
6. [9.4.6 static_assert](/教程/正文/语法和标准库/9_对象模型/9_4_声明/9_4_6_static_assert)
7. [9.4.7 存储期 链接](/教程/正文/语法和标准库/9_对象模型/9_4_声明/9_4_7_存储期_链接)
8. [9.4.8 定义](/教程/正文/语法和标准库/9_对象模型/9_4_声明/9_4_8_定义)

## 5. 习题

<Exercise id="10919" :d="1" :w="2">
...
<Exercise id="10920" :d="1" :w="2">

写出一个 `typedef`，使得下列声明不再需要括号：`int (*fp)(int, int);`。

</Exercise>

<Exercise id="10921" :d="1" :w="2">
