...
2. 必要时再结合 `errno` 或 `<fenv.h>`（见 18.7）。
...
<Exercise id="11702" :d="2" :w="2">

使用 `<math.h>` 中的函数解决 [**10407**](/教程/题解/语法和标准库/表达式/10407.md)。

</Exercise>

<Exercise id="11703" :d="3" :w="2">
