...
2. 必要时再结合 `errno` 或 `<fenv.h>`（见 19.10）。
...
<Exercise id="11902" :d="2" :w="2">

使用 `<math.h>` 中的函数解决 [**10307**](/教程/题解/语法和标准库/3_表达式与类型转换/10307)。

</Exercise>

<Exercise id="11903" :d="3" :w="2">
