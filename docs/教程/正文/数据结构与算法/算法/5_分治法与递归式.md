...
<Exercise id="30502" :d="1" :w="2">

对于递归式 $T(n) = T(n-1) + n$，使用代入法证明其解为 $T(n) = O(n^2)$。

</Exercise>

<Exercise id="30503" :d="1" :w="2">
...
<Exercise id="30504" :d="1" :w="2">

使用换元法，求解递归式 $T(n) = T(\sqrt{n}) + \Theta(\lg \lg n)$ 的时间复杂度。

</Exercise>

<Exercise id="30505" :d="1" :w="2">
