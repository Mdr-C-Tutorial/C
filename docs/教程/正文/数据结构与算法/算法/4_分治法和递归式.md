...
<Exercise id="30402" :d="1" :w="2">

对于递归式 $T(n) = T(n-1) + n$，使用代入法证明其解为 $T(n) = O(n^2)$。

</Exercise>

<Exercise id="30403" :d="1" :w="2">
...
<Exercise id="30404" :d="1" :w="2">

使用换元法，求解递归式 $T(n) = T(\sqrt{n}) + \Theta(\lg \lg n)$ 的时间复杂度。

</Exercise>

<Exercise id="30405" :d="1" :w="2">
